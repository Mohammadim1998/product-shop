...
const AllPosts: React.FC<PostsPropsTypes> = ({ setMidBanDetCtrl, setRandomNumForBannerClick }) => {
    const goTopCtrl = () => {
        window.scrollTo({
            top: 0,
            behavior: "smooth",
    ...
    const [posts, setPosts] = useState<ItemsPropsTypes[] | null>(null);
    ...
    const [allPostsNumber, setAllPostsNumber] = useState<number>(0);
    const paginate = 2;

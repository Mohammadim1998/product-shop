...
type BoxPaymentsPropsTypes = {
    setMidBanDetCtrl: (value: string) => void;
    setRandomNumForBannerClick: (value: number) => void;
    data: PaymentsPropsTypes;
}


const Box: React.FC<BoxPaymentsPropsTypes> = ({ data, setMidBanDetCtrl, setRandomNumForBannerClick }) => {
    ...
    return (
        <div
            ...
            <div className="flex flex-col gap-4">
                <div>مبلغ : {Number(data?.amount / 10).toLocaleString()} تومان</div>
